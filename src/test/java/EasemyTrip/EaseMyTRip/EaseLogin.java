...
public class EaseLogin 
{
	...
	{
		FileInputStream fis= new FileInputStream("C:\\Users\\DELL\\SELENIUM\\EaseMyTRip\\src\\test\\java\\EasemyTrip\\EaseMyTRip\\EaseMyTrip.properties");
		
		Properties p=new Properties();
		p.load(fis);
		String myFromDestination=p.getProperty("FromDestination");
        String myToDestination=p.getProperty("ToDestination");
        String Myddate=p.getProperty("Ddate");
